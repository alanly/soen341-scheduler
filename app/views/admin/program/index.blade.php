      ...
      @foreach( $programs as $p )
        <tr>
          ...
          <td>
            ...
            {{ Form::open( array('name' => 'del_' . $p->id . '_frm', 'class' => 'form-inline', 'url' => '/admin/program/' . $p->id) ) }}
              <a href="javascript:document.del_{{ $p->id }}_frm.submit()" title="Delete {{{ $p->description }}}."><i class="icon-trash"></i></a>
